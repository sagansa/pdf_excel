...
-- This script recreates hpp-related tables that were accidentally dropped
-- Run this ONLY to recover from accidental table drops

-- 1. Create hpp_batches table
...
-- 2. Create hpp_batch_transactions table
...
-- 3. Create hpp_batch_products table (WITHOUT product_id - using stock_monitoring_id only)
...
-- 4. Recreate products table (if you want to keep products feature)
-- COMMENT OUT this section if you want to remove products feature
...
-- 5. Recreate product-related tables (if products table exists)
-- COMMENT OUT this section if you want to remove products feature

  ...
  actions: {
    async fetchAssetGroups(companyId, assetType = null) {
      ...
      try {
        ...
        this.error =
          err.response?.data?.error || "Failed to fetch asset groups";
        throw err;
      } finally {
    ...
    async createAssetGroup(data) {
      try {
        ...
        throw new Error(
          err.response?.data?.error || "Failed to create asset group",
        );
      }
    },
    ...
    async updateAssetGroup(groupId, data) {
      try {
        const response = await api.put(
          `/amortization/asset-groups/${groupId}`,
          data,
        );
        return response.data;
      } catch (err) {
        throw new Error(
          err.response?.data?.error || "Failed to update asset group",
        );
      }
    },
    ...
    async getMarkSettings(companyId) {
      try {
        ...
        return {
          settings: DEFAULT_MARK_SETTINGS,
          available_marks: [],
        };
      }
    },
    ...
    async saveMarkSettings(data) {
      try {
        ...
        throw new Error(
          err.response?.data?.error || "Failed to save mark settings",
        );
      }
    },
    ...
    async createMarkMapping(data) {
      try {
        const response = await api.post("/mark-amortization-mappings", {
          ...
          is_deductible_50_percent:
            data.is_deductible_50_percent || false,
        });
        return response.data;
      } catch (err) {
        throw new Error(
          err.response?.data?.error || "Failed to create mark mapping",
        );
      }
    },
    ...
    async fetchAmortizationItems(companyId, year) {
      try {
        ...
        throw new Error(
          err.response?.data?.error || "Failed to fetch amortization items",
        );
      }
    },
    ...
    async createAmortizationItem(data) {
      try {
        ...
        throw new Error(
          err.response?.data?.error || "Failed to create amortization item",
        );
      }
    },
    ...
    async updateAmortizationItem(itemId, data) {
      try {
        ...
        throw new Error(
          err.response?.data?.error || "Failed to update amortization item",
        );
      }
    },
    ...
    async deleteAmortizationItem(itemId) {
      try {
        ...
        throw new Error(
          err.response?.data?.error || "Failed to delete amortization item",
        );
      }
    },
    ...
    async generateAmortizationJournals(data) {
      try {
        const response = await api.post(
          "/amortization-items/generate-journal",
          data,
        );
        return response.data;
      } catch (err) {
        throw new Error(
          err.response?.data?.error ||
            "Failed to generate amortization journals",
        );
      }
    },
  },

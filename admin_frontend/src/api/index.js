...
export const historyApi = {
  ...
  getRemainingStorages(params = {}) {
    return api.get('/remaining-storages', { params });
  },
  getRemainingStorageDetails(stockCardId, params = {}) {
    const encodedId = encodeURIComponent(stockCardId);
    return api.get(`/remaining-storages/${encodedId}/details`, { params });
  },

        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
              ...
              >
                ...
                <div
                  ...
                  class="absolute -top-1.5 -right-1.5 bg-white rounded-full"
                >
                  <i
                    :class="`bi bi-check-circle-fill text-${group.color}-500 text-sm`"
                  ></i>
                </div>
              </button>
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="space-y-1">
              ...
              <select
                class="input-base bg-white py-2"
          ...
          <div class="pt-4">
            ...
            <div
              ...
              class="mt-4 p-4 bg-red-50 border border-red-100 rounded-xl text-red-700 text-sm"
            >
            ...
            <div
              ...
              class="mt-4 p-4 bg-green-50 border border-green-100 rounded-xl text-green-700 text-sm"
            >

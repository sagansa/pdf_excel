    ...
    <div class="flex-grow flex items-center justify-center">
      <div class="w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white shadow-sm rounded-lg p-6 sm:p-8 h-[80vh] flex flex-col">
          <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 text-center mb-6">Bank Statement PDF to Excel
            Converter</h1>
            ...
            <div class="flex flex-col items-center justify-center space-y-2">
              ...
              <div class="flex items-center flex-wrap justify-center gap-4">
                <a href="mailto:admin@sagansa.id"
                  class="text-sm text-gray-600 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400 transition-colors duration-200">
